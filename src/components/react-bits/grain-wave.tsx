...
const ShaderPlane: React.FC<ShaderPlaneProps> = ({
  ...
  useFrame((state) => {
    ...
    u.u_waveCount!.value = waveCount;
    u.u_waveAmplitude!.value = waveAmplitude;
    u.u_waveFrequency!.value = waveFrequency;
    u.u_lineThickness!.value = lineThickness;
    u.u_grainIntensity!.value = grainIntensity;
    u.u_startColor!.value.set(startColor);
    u.u_endColor!.value.set(endColor);
    u.u_backgroundColor!.value.set(backgroundColor);
    u.u_brightness!.value = brightness;
    u.u_speedVariation!.value = speedVariation;
    u.u_waveWidth!.value = waveWidth;
