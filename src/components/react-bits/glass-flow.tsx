...
const ShaderPlane: React.FC<ShaderPlaneProps> = ({
  ...
  useFrame((state) => {
    ...
    u.u_viewport!.value.set(size.width, size.height);
    u.u_texture!.value = texture;
    u.u_textureSize!.value = textureSize;
    u.u_stripeCount!.value = stripeCount;
    u.u_angle!.value = (angle * Math.PI) / 180;
    u.u_lensCurvature!.value = lensCurvature;
    u.u_refraction!.value = refraction;
    u.u_edgeWidth!.value = edgeWidth;
    u.u_edgeBrightness!.value = edgeBrightness;
    u.u_edgeSharpness!.value = edgeSharpness;
    u.u_speed!.value = speed;
    u.u_chromaticAberration!.value = chromaticAberration;
    u.u_waveSpeed!.value = waveSpeed;
    u.u_waveAmount!.value = waveAmount;
    u.u_frostAmount!.value = frostAmount;
  });
