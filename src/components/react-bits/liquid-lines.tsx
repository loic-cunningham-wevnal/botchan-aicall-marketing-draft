...
const ShaderPlane: React.FC<ShaderPlaneProps> = ({
  ...
  useFrame((state) => {
    if (materialRef.current) {
      const u = materialRef.current.uniforms as Record<string, { value: any }>;
